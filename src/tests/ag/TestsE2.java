...
public class TestsE2 {
	...
	public static void main(String[] args) {
		AlgoritmoAG.POPULATION_SIZE = 900000;  // aumentar si no se obtiene un optimo
		StoppingConditionFactory.NUM_GENERATIONS = 70000000; // aumentar si no se obtiene un optimo
